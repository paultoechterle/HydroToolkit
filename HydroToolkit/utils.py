...
def cross_plot(figsize:tuple=(5,3)):
    ...
    ax.fill(dolo[:,0], dolo[:,1], alpha=0.5, color=colors[0], label='Dolomitwasser')
    ax.fill(co3[:,0], co3[:,1], alpha=0.5, color=colors[2], label='Kalziumkarbonatwasser')
    ax.fill(alluv[:,0], alluv[:,1], alpha=0.5, color=colors[6], label='Quartäre Aquifere')
